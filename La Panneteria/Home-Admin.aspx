...
<body>
    ...
    <div class="grid">
        ...
        <div class="menu" id="menu_container">
                        <div align="center" class="menuitem"><br /><img src="/Images/Admin/ABMInsumos.jpg" alt="Insumos" width="95%">
                        <p id="texto_insumos"><b>Inventario de Insumos</b></p></div>
                        <div align="center" class="menuitem"><br /><img src="/Images/Admin/ABMProductos.jpg" alt="Productos" width="95%">
                        <p id="texto_backup"><b>Inventario de productos</b></p></div>
                        <div align="center" class="menuitem"><br /><img src="/Images/Admin/ABMUsuarios.jpg" alt="Backup" width="95%">
